...
Este año presenté este proyecto en LatinR, acá se puede ver la presentación:
...
La solución final combina R y Shiny con Node usando Docker para garantizar la seguridad y privacidad de los datos, implementando un modelo de autorización que refleja la lógica de negocio, y permite visualizarlos en una aplicación interactiva. 
