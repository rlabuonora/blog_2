...
En este post uso una de las _killer features_ de Git para seguir el ejemplo de Hadley. Esta _feature_ son las branches (si bien otros SVNs tienen branches, Git las hace muy fáciles de usar).
...
Este post es se me ocurrió leyendo el [capítulo de flujos de trabajo de Mastering Shiny](https://mastering-shiny.org/action-workflow.html#case-study). El ejemplo es una app con un selector para elegir la región y listar los registros del archivo de `csv` que pertenecen a esa región.
