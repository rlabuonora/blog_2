...
categories: []
tags: ["spatial", "R", "vis"]
description: "Un choropleth para visualizar la distribución geográfica de la riqueza en Montevideo."
---
...
ingresos_ech <- read_tsv("../../public/ech/H_2018_Terceros.dat") %>% 
...
# Cargar mapa
ine_seg_11_sf <- st_read('../../public/shps/ine_seg_11/ine_seg_11.shp')
# asignar crs
...
Sys.setlocale("LC_ALL", "UTF-8")
medianas <- read_tsv("../../public/ech/H_2018_Terceros.dat") %>% 
  transmute(id       =as.character(numero),
            depto_id = dpto, 
            depto = nomdpto,
            localidad_id = as.numeric(locagr),
