...
En este post cuento como poner un LLM en una instancia EC2. La solución usa contendores Docker con Ollama y OpenWebUI. Tengo una suscripción a ChatGPT que me parece un gran producto, pero
hay alguna info de trabajo que no puedo subir. Además, esta solución permite correr
cualquier modelo opensource disponible en Ollama.
